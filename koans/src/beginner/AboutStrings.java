...
public class AboutStrings {
    ...
    public void implicitStrings() {
        assertEquals("just a plain ole string".getClass(), String.class); // getClass returns obj (called meta class) of that class
    }
...
*/
    ...
    public void insufficientArgumentsToStringFormatCausesAnError() {
        try {
            ...
            assertEquals(e.getMessage(), MissingFormatArgumentException.class.getName());
        }
    }
