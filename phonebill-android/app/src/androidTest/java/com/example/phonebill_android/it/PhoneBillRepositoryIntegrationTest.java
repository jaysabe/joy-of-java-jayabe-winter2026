...
public class PhoneBillRepositoryIntegrationTest {

  private static final String CUSTOMER = "Repository Test Customer";
  ...
  @Test
  public void loadBillReturnsEmptyBillWhenNoSavedFileExists() throws Exception {
    Context context = InstrumentationRegistry.getInstrumentation().getTargetContext();
    context.deleteFile(fileNameFor(CUSTOMER));

    PhoneBill bill = this.repository.loadBill(context, CUSTOMER);
  ...
  @Test
  public void saveAndLoadBillRoundTripsCallsThroughInternalStorage() throws Exception {
    Context context = InstrumentationRegistry.getInstrumentation().getTargetContext();
    ...
    assertEquals("503-555-1111", loadedCall.getCaller());
    assertEquals("503-555-2222", loadedCall.getCallee());
  }
