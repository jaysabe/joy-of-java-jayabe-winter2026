...
public class TextParserTest {
  ...
  void canParseValidPhoneBillWithMultipleCalls() throws ParserException {
    ...
    String call1 = "503-555-1234,503-555-6789,01/15/2025 10:00,01/15/2025 10:30";
    String call2 = "503-555-1234,503-555-9999,01/16/2025 12:00,01/16/2025 12:15";
  ...
  void malformattedLineMissingFieldsThrowsParserException() {
    String content = "John Doe\n503-555-1234,503-555-6789,01/15/2025 10:00"; // Missing end time
    TextParser parser = new TextParser(new StringReader(content));

    ParserException ex = assertThrows(ParserException.class, parser::parse);
    assertThat(ex.getMessage(), containsString("expected 4 fields"));
  }

  @Test
  void invalidDateFormatThrowsParserException() {
    // Note the "2025/15/01" which doesn't match MM/dd/yyyy
    String content = "John Doe\n503-555-1234,503-555-6789,2025/15/01 10:00,01/15/2025 10:30";
    TextParser parser = new TextParser(new StringReader(content));
  ...
  void blankLinesBetweenCallsAreIgnored() throws ParserException {
    String content = "John Doe\n\n503-555-1234,503-555-6789,01/15/2025 10:00,01/15/2025 10:30\n\n";
    TextParser parser = new TextParser(new StringReader(content));
