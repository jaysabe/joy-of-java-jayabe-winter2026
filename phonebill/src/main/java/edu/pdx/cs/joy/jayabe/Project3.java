...
public class Project3 {
   ...
   * This method handles option flags (-print, -README, -textFile, -pretty), extracts and validates
  ...
  private static void printREADME() {
    ...
    System.out.println("and pretty printing phone bills with call duration in minutes.");
    System.out.println();
